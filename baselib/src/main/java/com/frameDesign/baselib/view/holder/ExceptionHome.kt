...
class UnknownStateException :
    IllegalAccessException(" undefined state , not find Adapter by state! ")

/**
 * 当指定[HolderView.mViewRecycle]
 */
class ViewRecycleException :
    IllegalAccessException(" When you reuse you have to be in the state of the View ")
