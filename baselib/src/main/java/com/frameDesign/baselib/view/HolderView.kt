package com.frameDesign.baselib.view
...
import com.frameDesign.baselib.view.holder.*
import com.frameDesign.baselib.view.adapter.BaseAdapter
import com.frameDesign.baselib.utils.expand.gone
import com.frameDesign.baselib.utils.expand.setVisible
import com.frameDesign.baselib.view.internal.HolderInternal
import com.frameDesign.baselib.utils.expand.show
import com.frameDesign.baselib.utils.expand.tryGetAllChildView
import java.util.*
 ...
 * @date 2018/10/17
 */
class HolderView @JvmOverloads constructor(context: Context,
    ...
    init {
        val a = getContext().obtainStyledAttributes(attrs,
                R.styleable.jb_holder_view, defStyle, 0)
        ...
        mEmptyLayoutId = a.getResourceId(R.styleable.jb_holder_view_jb_holder_empty,
            NULL_LAYOUT_ID
        )
        mErrorLayoutId = a.getResourceId(R.styleable.jb_holder_view_jb_holder_error,
            NULL_LAYOUT_ID
        )
        mLoadingLayoutId = a.getResourceId(R.styleable.jb_holder_view_jb_holder_loading,
            NULL_LAYOUT_ID
        )
        mNoNetworkLayoutId = a.getResourceId(R.styleable.jb_holder_view_jb_holder_noNet,
            NULL_LAYOUT_ID
        )
...
//        // 防止用户设置View背景导致覆盖下面的内容
    ...
    private fun switchLayout(state: Int, lRes: Int, force: Boolean = false) {
        ...
        onPerformTransition(adapter,
                holder, last, state, !force)
    }
...
//            var exitAnim = la.getHolderTransformAnim(lh, this, lastState, nextState, false)
            var enterAnim = na.getHolderTransformAnim(nh, this, lastState, nextState, true)
//            exitAnim.cancel()
    ...
    private fun createHolderByAdapter(adapter: BaseAdapter<*>,
                                      @LayoutRes layoutRes: Int = NULL_LAYOUT_ID
    ): BaseHolder {
